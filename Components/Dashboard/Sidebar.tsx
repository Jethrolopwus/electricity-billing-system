  ...
  return (
    <div className="bg-gray-800 text-white min-h-screen w-1/5 p-4">
      ...
      <ul className='mt-8 '>
        ...
        <li className="mb-2 mt-8 border-2 rounded-xl text-xl text-center bg-slate-900 text-white "> <Link href="UserProfile">Profile </Link></li>
        <li className="mb-2 mt-8 border-2 rounded-xl text-xl text-center bg-slate-900 text-white "> <Link href='/settings'>Settings </Link></li>
      </ul>
    </div>
  )
}
